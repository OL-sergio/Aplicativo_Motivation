package udemy.sergi.aplicativo_motivation.repository
...
class Mock {
    ...
    private val mListPhases: List<Phrase> = listOf(
    ...
    fun getPhrase(value: Int): String {
        val filtered = mListPhases.filter { (it.category == value || value == all) }
